...
object ZioKafka extends ZIOAppDefault {
  ...
  val footballMatchesStream = Consumer
  ...
  val matchesStreams: ZStream[Any with Consumer, Throwable, CommittableRecord[
    String,
    Match
  ]] =
    Consumer
  ...
  val matchesPrintableStream
      : ZStream[Any with Consumer, Throwable, (String, Offset)] =
    matchesStreams
