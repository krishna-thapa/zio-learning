...
object ContextualAbstractionsScala3 extends App:
  ...
  given Int                                     = 10 // can give  variable name "given defaultAmount: Int = 10"
  ...
  val krishnaGreeting = "Krishna".greet()
  ...
  println(s"Using the given and using: $sum10")
  println(s"Using the extension: $sum10_v2")
