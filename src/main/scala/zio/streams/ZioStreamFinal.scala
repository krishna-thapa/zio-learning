...
object ZioStreamFinal extends ZIOAppDefault {
  ...
  val addTags: Set[String] => ZPipeline[Any, Nothing, String, String] = (tags: Set[String]) =>
  ...
  // Objective 3
  def createTagIndexFile(tagMap: Map[String, Set[String]]): ZIO[Any, Throwable, Long] = {
    val searchMap: Map[String, Set[String]] = tagMap
      .values
